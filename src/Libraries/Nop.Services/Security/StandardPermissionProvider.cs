...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord ManageMultifactorAuthenticationMethods = new PermissionRecord { Name = "Admin area. Manage Multifactor Authentication Methods", SystemName = "ManageMultifactorAuthenticationMethods", Category = "Configuration" };
