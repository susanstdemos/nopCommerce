...
namespace Nop.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
        ...
        {
            var defaultFormat = SKEncodedImageFormat.Jpeg;
            ...
            string storeLocation = null)
        {
            ...
            else
            {
                ...
                {
                    var pictureBinary = ImageResize(image, EncodedImageFormat(fileExtension), targetSize);
                    SaveThumb(thumbFilePath, thumbFileName, string.Empty, pictureBinary);
                }
                mutex.ReleaseMutex();
            ...
            else
            {
                ...
                if (pictureBinary != null)
                {
                    try
                    {
                        ...
                        pictureBinary = ImageResize(image, EncodedImageFormat(picture.MimeType), targetSize);
                    }
                    catch
                    {
                    }
